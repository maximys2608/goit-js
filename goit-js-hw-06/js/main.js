...
const getNamesSortedByFriendsCount = users => {
  const sortByfriends = (userOne, userTwo) => userOne["friends"].length - userTwo["friends"].length;
...
// [ 'adipisicing', 'amet', 'anim', 'commodo', 'culpa', 'elit', 'ex', 'ipsum', 'irure', 'laborum', 'lorem', 'mollit', 'non', 'nost